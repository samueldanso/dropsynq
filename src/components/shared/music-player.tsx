...
export default function MusicPlayer({
	...
	// Auto play when shouldPlay is true
	useEffect(() => {
		if (shouldPlay && isOpen && track && audioRef.current) {
			audioRef.current.play();
			setIsPlaying(true);
			onDidPlay?.();
		}
	}, [shouldPlay, isOpen, track, onDidPlay]);

	// Pause externally if requested
	useEffect(() => {
		if (pauseExternal && audioRef.current) {
