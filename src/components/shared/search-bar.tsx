  ...
  return (
    <div className="relative w-full">
      ...
      <Input
        ...
        className="h-12 w-full rounded-full border-none bg-gray-800/90 text-foreground shadow-md pl-11 pr-4 focus:bg-background focus:ring-2 focus:ring-ring placeholder:text-gray-400"
      />
